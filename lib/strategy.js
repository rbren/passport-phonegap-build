...
function Strategy(options, verify) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || 'https://build.phonegap.com/authorize';
  options.tokenURL = options.tokenURL || 'https://build.phonegap.com/authorize/token';
  options.scopeSeparator = options.scopeSeparator || ',';
  options.customHeaders = options.customHeaders || {};

  if (!options.customHeaders['User-Agent']) {
    options.customHeaders['User-Agent'] = options.userAgent || 'passport-phonegap-build';
  }

  OAuth2Strategy.call(this, options, verify);
  this.name = 'phonegap-build';
  this._userProfileURL = options.userProfileURL || 'https://build.phonegap.com/api/v1/me';
...
Strategy.prototype.userProfile = function(accessToken, done) {
  this._oauth2.get(this._userProfileURL, accessToken, function (err, body, res) {
    ...
    profile.provider  = 'phonegap-build';
    profile._raw = body;
    profile._json = json;
